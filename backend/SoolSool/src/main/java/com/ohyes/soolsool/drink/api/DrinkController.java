...
public class DrinkController {
    ...
    public ResponseEntity<Object> drinkAdd(@RequestBody DrinkRequestDto drinkRequestDto,
        ...
        try {
            drinkService.drinkAdd(drinkRequestDto, userDetails);
    ...
    public ResponseEntity<Object> drinkPhotoAdd(@PathVariable LocalDate drinkDate,
        ...
        throws Exception {
        try {
            uploadService.drinkPhotoAdd(drinkDate, multipartFile, userDetails);
    ...
    public ResponseEntity<Object> drinkModify(@RequestBody DrinkRequestDto drinkRequestDto,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        try {
            drinkService.drinkModify(drinkRequestDto, userDetails);
    ...
    public ResponseEntity<Object> drinkDelete(@RequestBody DrinkRequestDto drinkRequestDto,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        try {
            drinkService.drinkDelete(drinkRequestDto, userDetails);
    ...
    public ResponseEntity<Object> dailyDrinkGet(@PathVariable LocalDate drinkDate,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        try {
            DailyDrinkDto dailyDrinkDto = drinkGetService.dailyDrinkGet(drinkDate, userDetails);
    ...
    public ResponseEntity<Object> drinkEventDelete(@PathVariable LocalDate drinkDate,
        @AuthenticationPrincipal UserDetailsImpl userDetails) {
        try {
            drinkService.drinkEventDelete(drinkDate, userDetails);
